...
int define_surveys(char surveynames[MAX_STRLEN][MAX_SURVEYS])
{
  ...
  strcpy(surveynames[32],"fast_uwb1");
...
void defineParameters(paramtype *defParam)
{
  ...
  addParameter(defParam,"DIST_DM","%9.2f","DIST_DM","(kpc)","Distance based on the YMW16 electron density model",4,0);
  addParameter(defParam,"DIST_DM1","%9.2f","DIST_DM1","(kpc)","Distance based on the NE2001 electron density model",4,0);
